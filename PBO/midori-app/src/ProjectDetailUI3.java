import com.formdev.flatlaf.themes.FlatCarbonLookAndFeel; // 💡 Impor Tema Carbon
...
public class ProjectDetailUI3 extends JFrame {

    private DefaultTableModel productTableModel;
    private DefaultTableModel tasksTableModel;
    private DefaultTableModel commentsTableModel;

    public ProjectDetailUI3() {
        // --- 1. SET FLATLAF MENGGUNAKAN TEMA CARBON ---
       try {
            // Menggunakan FlatCarbonLookAndFeel
            UIManager.setLookAndFeel(new FlatCarbonLookAndFeel()); 
            
        } catch (Exception ex) {
            System.err.println("Failed to initialize Flat Carbon Theme: " + ex);
        }
        // ---------------------------------------------
