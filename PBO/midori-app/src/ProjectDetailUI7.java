import com.formdev.flatlaf.intellijthemes.FlatOneDarkLookAndFeel;
import net.miginfocom.swing.MigLayout;
import javax.swing.*;
import javax.swing.border.TitledBorder;
import javax.swing.table.DefaultTableModel;
import javax.swing.table.DefaultTableCellRenderer; // Import untuk renderer tabel
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import java.util.Vector;
import java.util.Arrays;
import java.awt.Color; // Import untuk Color
import java.awt.Component; // Import untuk Component

public class ProjectDetailUI7 extends JFrame {

    private DefaultTableModel productTableModel;
    private DefaultTableModel tasksTableModel;
    private DefaultTableModel commentsTableModel;

    // --- CUSTOM RENDERER UNTUK HEADER HIJAU MINT ---
    private static class MintGreenHeaderRenderer extends DefaultTableCellRenderer {
        // Warna Hijau Mint (Custom RGB: 102, 255, 180)
        private static final Color MINT_GREEN = new Color(102, 255, 180); 

        public MintGreenHeaderRenderer() {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            // Mengatur warna teks (foreground) menjadi hijau mint
            c.setForeground(MINT_GREEN);
    ...
    public ProjectDetailUI7() {
        // --- 1. SET FLATLAF MENGGUNAKAN TEMA ONE DARK ---
        try {
            UIManager.setLookAndFeel(new FlatOneDarkLookAndFeel()); 
        } catch (Exception ex) {
            System.err.println("Failed to initialize Flat One Dark Theme. Please check VS Code configuration: " + ex);
            // Fallback ke tema bawaan (atau tema Light jika dark gagal)
            try {
...
// -----------------------------------------------------------------------------
    ...
    // ... (metode createClientPanel, createInformationPanel, createAdditionalInformationPanel, createControlsPanel)
    // Dibiarkan sama seperti kode terakhir Anda
    ...
    private JPanel createProductListPanel() {
        ...
        // --- 2. TERAPKAN RENDERER HIJAU MINT PADA HEADER TABEL PRODUCT ---
        productTable.getTableHeader().setDefaultRenderer(new MintGreenHeaderRenderer());
        // ------------------------------------------------------------------
    ...
    private JPanel createTasksPanel() {
        ...
        // --- 3. TERAPKAN RENDERER HIJAU MINT PADA HEADER TABEL TASKS ---
        tasksTable.getTableHeader().setDefaultRenderer(new MintGreenHeaderRenderer());
        // ----------------------------------------------------------------
    ...
    private JPanel createCommentsPanel() {
        ...
        // --- 4. TERAPKAN RENDERER HIJAU MINT PADA HEADER TABEL COMMENTS ---
        commentsTable.getTableHeader().setDefaultRenderer(new MintGreenHeaderRenderer());
        // -------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//                            CRUD UTILITY & LOGIC (Sama seperti sebelumnya)
// -----------------------------------------------------------------------------
