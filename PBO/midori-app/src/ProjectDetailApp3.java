...
public class ProjectDetailApp3 { // Nama Class sesuai dengan file ProjectDetailApp3.java
    ...
    private static void createAndShowGUI() {
        ...
        // --- 2. Panel Konten Utama (Menggunakan GridBagLayout) ---
        JPanel mainContentPanel = new JPanel(new GridBagLayout());
        mainContentPanel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
        GridBagConstraints gbc = new GridBagConstraints();
        gbc.fill = GridBagConstraints.HORIZONTAL; // Komponen mengisi lebar sel
        gbc.insets = new Insets(5, 5, 5, 5); // Padding antar komponen
        gbc.weightx = 1.0; // Semua komponen di kolom 0 akan menyebar secara horizontal
        ...
        // Tambahkan panel konten ke frame utama (di dalam JScrollPane)
    ...
    private static JPanel createInfoPanel() {
        ...
        gbc.gridx = 1; gbc.weightx = 1.0; gbc.fill = GridBagConstraints.HORIZONTAL; detail.add(new JTextField("0 of 30", 8), gbc);
    ...
    private static JPanel createProductListPanel() {
        ...
        // Menggunakan Box.createVerticalGlue() agar subtotal menempel di bawah
        JPanel southWrapper = new JPanel();
        southWrapper.setLayout(new BoxLayout(southWrapper, BoxLayout.Y_AXIS));
        southWrapper.add(Box.createVerticalGlue());
        southWrapper.add(subtotalDetail);
        
        rightControlPanel.add(southWrapper, BorderLayout.SOUTH);
    ...
    private static JPanel createTasksPanel() {
        ...
        // Panel Tombol Vertikal di Kanan
        JPanel buttonPanel = new JPanel(new GridLayout(3, 1, 0, 5));
        buttonPanel.add(new JButton("Add"));
        buttonPanel.add(new JButton("Edit"));
        buttonPanel.add(new JButton("Delete"));
    ...
    // Penutup Class ProjectDetailApp3
}