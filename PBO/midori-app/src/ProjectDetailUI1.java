...
public class ProjectDetailUI1 extends JFrame {
    ...
    public ProjectDetailUI1() {
        ...
        // --- Layout Penempatan Panel (Sama seperti sebelumnya) ---
    ...
    /**
     * Panel Product List (Menggunakan Anonymous Inner Class untuk tombol)
     */
    private JPanel createProductListPanel() {
        ...
        final JTable productTable = new JTable(productTableModel); // Menggunakan final untuk anonymous class
        ...
        // --- Interaksi CRUD (Menggunakan Anonymous Class: LEBIH ROBUST) ---
    ...
    /**
     * Panel Tasks (Menggunakan Lambda Expression)
     */
    ...
    /**
     * Panel Comments (Menggunakan Lambda Expression)
     */
    ...
    // Utility untuk membuat Vector data (Tidak Berubah)
