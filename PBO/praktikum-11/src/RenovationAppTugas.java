...
public class RenovationAppTugas {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            JPanel panelInformation = new JPanel(new MigLayout(
                    "wrap 3",
                    "[right]10[left, grow, fill]5[fill]"
            ));
            ...
            JPanel panelTableProductList = new JPanel(new MigLayout("wrap 3", "[grow][left][right]", "[][ ][][ ]"));

            String[] kolomTableProductList = {
                "Renovation", "Description", "Part #", "Quantity", "List Price",
                "Discount", "Price", "Wholesale Discount", "Wholesaler Price"
            };
            ...
            panelTask.add(scrollPaneTableTask, "grow, hmin 150, hmax 190");
            ...
            panelComments.add(scrollPaneTableComment, "grow, hmin 150, hmax 190");
    ...
    private static void installModernScrollChaining(JFrame frame, JScrollPane mainScrollPane) {
        ...
        Toolkit.getDefaultToolkit().addAWTEventListener(event -> {
            ...
            newValue = Math.max(mainBar.getMinimum(),
